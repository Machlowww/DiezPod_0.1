...
class SimpleGoogleCalendarApiService {
  // Using public iCal approach which doesn't require OAuth
  ...
  async getTodayEvents(): Promise<CalendarEvent[]> {
    try {
      console.log('Fetching public iCal data...');
      ...
      // Return sample data if iCal fails
...
export const simpleGoogleCalendarApi = new SimpleGoogleCalendarApiService();
